...
# # print function allows you to make an input to the console
...
# home_address = input ("what is your home address? ")
# # print out the home address of the user
# print("you live at" + home_address)
# # print out the phone number of the user
...
name = "mauricio" #whenever you see text in quotes it is a string
# # integers are whole numbers
age = 17 #no quotes around the numbers
# # floats are decimal numbers
height = 5.6 # a number with a decimal point
